...
contract ERC20Interface {
    ...
    function transferFrom(address from, address to, uint tokens) external payable returns (bool success);
...
contract VRC is ERC20Interface, SafeMath ,Ownable{
   ...
   * function reverts back if sender addresss is invalid or address is zero and also keep the track ofsold tokens
   */
    function transfer(address to, uint tokens) public returns (bool success) {
   ...
   * function reverts back if sender addresss is invalid or address is zero and also keep the track of sold token
   */
    function transferFrom(address from, address to, uint tokens) external payable returns (bool success) {
